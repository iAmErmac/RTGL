...
enum FramebufferImageIndex
{
    ...
    FB_IMAGE_INDEX_DESKTOP_MIRROR = 30,
    FB_IMAGE_INDEX_MOTION_DLSS = 31,
    FB_IMAGE_INDEX_REACTIVITY = 32,
    FB_IMAGE_INDEX_HUD_ONLY = 33,
    FB_IMAGE_INDEX_ACCUM_HISTORY_LENGTH = 34,
    FB_IMAGE_INDEX_ACCUM_HISTORY_LENGTH_PREV = 35,
    FB_IMAGE_INDEX_DIFF_TEMPORARY = 36,
    ...
    FB_IMAGE_INDEX_INDIR_ACCUM = 48,
    FB_IMAGE_INDEX_INDIR_ACCUM_PREV = 49,
    FB_IMAGE_INDEX_INDIR_PING = 50,
    FB_IMAGE_INDEX_INDIR_PONG = 51,
    FB_IMAGE_INDEX_ATROUS_FILTERED_VARIANCE = 52,
    FB_IMAGE_INDEX_NORMAL_DECAL = 53,
    FB_IMAGE_INDEX_SCATTERING = 54,
    FB_IMAGE_INDEX_SCATTERING_PREV = 55,
    FB_IMAGE_INDEX_SCATTERING_HISTORY = 56,
    FB_IMAGE_INDEX_SCATTERING_HISTORY_PREV = 57,
    FB_IMAGE_INDEX_SCREEN_EMIS_R_T = 58,
    FB_IMAGE_INDEX_SCREEN_EMISSION = 59,
    FB_IMAGE_INDEX_BLOOM = 60,
    ...
    FB_IMAGE_INDEX_BLOOM_MIP6 = 66,
    FB_IMAGE_INDEX_BLOOM_MIP7 = 67,
    ...
    FB_IMAGE_INDEX_INDIRECT_RESERVOIRS_INITIAL = 72,
    FB_IMAGE_INDEX_GRADIENT_INPUTS = 73,
    FB_IMAGE_INDEX_GRADIENT_INPUTS_PREV = 74,
    FB_IMAGE_INDEX_D_I_S_PING_GRADIENT = 75,
    FB_IMAGE_INDEX_D_I_S_PONG_GRADIENT = 76,
    FB_IMAGE_INDEX_D_I_S_GRADIENT_HISTORY = 77,
    FB_IMAGE_INDEX_GRADIENT_PREV_PIX = 78,
};
...
constexpr uint32_t ShFramebuffers_Count = 79;
